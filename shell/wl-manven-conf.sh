...
$MVN_HOME/bin/mvn6 -version |tee -a $LOG
...
$JAVA_HOME/bin/java -jar $WLS_HOME/server/lib/wljarbuilder.jar -profile wlfullclient |tee -a $LOG
...
$MVN_HOME/bin/mvn6 install:install-file -DgroupId=com.oracle.cryptoj -DartifactId=cryptoj -Dversion=1.0 -Dpackaging=jar -Dfile=$FMW_HOME/modules/cryptoj.jar -DgeneratePom=true |tee -a $LOG
...
$MVN_HOME/bin/mvn6 install:install-file -DgroupId=oracle.soa.utils -DartifactId=common -Dversion=11.1  -Dpackaging=jar -Dfile=$ORACLE_HOME/soa/modules/oracle.soa.fabric_11.1.1/fabric-runtime.jar  -DgeneratePom=true |tee -a $LOG


echo -e "\nInstall maven plugin"  |tee -a $LOG
$MVN_HOME/bin/mvn6 install:install-file -Dfile=weblogic-maven-plugin.jar -DpomFile=pom.xml  |tee -a $LOG
...
$MVN_HOME/bin/mvn6  weblogic:help |tee -a $LOG
